...
$mod_strings = array (
	...
	'LBL_CAMPAIGN_DAYS_REMAIN' => 'Día restantes',
	...
	//error messages.
	'ERR_NO_EMAIL_MARKETING'=>'Debe haber al menos un mensaje de marketing por e-Mail asociado con la campaña',
	'ERR_NO_TARGET_LISTS'=>'Debe haber al menos una lista de público objetivo asociada con la campaña',
	'ERR_NO_TEST_TARGET_LISTS'=>'Il doit y avoir au moins une liste de destinataires de test associée à une campagne.',
	'ERR_SENDING_NOW'=>'Los mensajes están siendo enviados, por favor inténtelo de nuevo más tarde',
	'ERR_MESS_NOT_FOUND_FOR_LIST'=>'No se ha definido un mensaje de marketing por e-Mail para esta lista de público objetivo',
	'ERR_MESS_DUPLICATE_FOR_LIST'=>'Se han definido múltiples mensajes de marketing por e-Mail para esta lista de público objetivo',
	...
	'LBL_WIZARD_MARKETING_MESSAGE' => 'Rellene el siguiente formulario para crear una instancia de e-Mail para su boletín de noticias.  Esto le permitirá especificar cuándo y cómo su boletín de noticias debería ser distribuido',
	'LBL_WIZARD_SENDMAIL_MESSAGE' => 'Éste es el último paso del proceso.  Elija si quiere enviar una prueba, planear la distribución de su boletín de noticias, o simplemente guardar su trabajo e ir al resumen',
	...
	'LBL_WIZ_TEST_EMAIL_TITLE' => 'Probar e-Mail',
	...
	'LBL_CONFIRM_CAMPAIGN_SAVE_CONTINUE' => 'Guardar el trabajo y proceder con el e-Mail de marketing',
	...
	'LBL_MARKETING_CHECK1_GOOD' => 'Se han detectado los componentes de marketing por e-Mail',
	'LBL_MARKETING_CHECK1_BAD'  => 'No se han detectado los componentes de marketing por e-Mail, necesitará crear uno para enviar e-Mail a una campaña',
	...
	'LBL_LEAD_FORM_FIRST_HEADER' => 'Formularo de cliente potencial (primera columna)',
	'LBL_LEAD_FORM_SECOND_HEADER' =>'Formularo de cliente potencial (segunda columna)',
