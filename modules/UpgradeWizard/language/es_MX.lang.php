...
$mod_strings = array(
	...
	'ERR_UW_NO_VIEW2'							=> 'La vista no ha sido definida.  Por favor, vaya al inicio de la administración para navegar a esta página',
	...
	'LBL_UW_END_DESC'							=> 'Su sistema ha sido actualizado correctamente',
	...
	'LBL_UW_MODULE_READY_UNINSTALL'				=> "El módulo está listo para ser desinstalado.  Haga click en \"Proceder\" para proceder con la instalación<br>\n",
	'LBL_UW_MODULE_READY'						=> "El módulo está listo para ser instalado.  Haga click en \"Proceder\" para proceder con la instalación",
	...
	'LBL_UW_PATCH_READY'						=> 'El parche está preparado para ser procesado. Haga click en el botón "Proceder" para completar el proceso de actualización',
	'LBL_UW_PATCH_READY2'						=> '<h2>Aviso: Se han encontrado diseños personalizados</h2><br />Los siguientes archivos tienen campos nuevos o diseños de pantalla modificados aplicados vía Estudio. El parche que va a instalar también contiene cambios a los archivos. Para <u>cada archivo</u> puede:<br><ul><li>[<b>Por defecto</b>] Mantener su versión dejando en blanco la casilla. Las modificaciones contenidas en el parche serán ignoradas.</li>o<li>Aceptar los archivos actualizados marcando la casilla. Sus diseños necesitarán ser aplicados de nuevo vía Estudio.</li></ul>',
	...
	'LBL_UW_SKIPPING_FILE_OVERWRITE'			=> 'Omitiendo la sobrescritura de archivos - Seleccionada combinación manual',
	...
	'LBL_UW_START_DESC2'						=> 'Recomendamos encarecidamente que realice la actualización contra una instancia clonada de su servidor en producción. Por favor, haga una copia de su base de datos y de sus archivos de sistema (todos los archivos de su carpeta de SuiteCRM) antes de realizar esta operación.',
	...
	'LBL_UW_FOLLOWING_MODULES_UPGRADED'         => 'Se han detectado los siguientes módulos como personalizados usando Estudio y serán actualizados',
