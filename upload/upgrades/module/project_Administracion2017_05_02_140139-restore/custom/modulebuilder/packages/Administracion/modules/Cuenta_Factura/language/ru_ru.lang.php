...
$mod_strings = array (
  ...
  'LBL_REMOVE' => 'Удалить',
  'LBL_MODULE_NAME' => 'Factura del Cliente',
  'LBL_MODULE_TITLE' => 'Factura del Cliente',
  'LNK_NEW_DOCUMENT' => 'Создать документ',
  'LNK_DOCUMENT_LIST' => 'Документы',
  'LBL_SEARCH_FORM_TITLE' => 'Поиск Factura del Cliente',
  ...
  'LBL_NEW_FORM_TITLE' => 'Новый Factura del Cliente',
  ...
  'LBL_LIST_FORM_TITLE' => 'Factura del Cliente Список',
  ...
  'LBL_HOMEPAGE_TITLE' => 'Мой Factura del Cliente',
  'LNK_NEW_RECORD' => 'Создать Factura del Cliente',
  'LNK_LIST' => 'View Factura del Cliente',
  'LNK_IMPORT_ADMIN_CUENTA_FACTURA' => 'Importar Factura del Cliente',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Просмотр истории',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Мероприятия',
  'LBL_ADMIN_CUENTA_FACTURA_SUBPANEL_TITLE' => 'Factura del Cliente',
  'LBL_JL_SERIE' => 'Serie',
  'LBL_JL_FECHAFACTURA' => 'Fecha de la factura',
  'LBL_JL_SUBTOTAL' => 'Subtotal',
  'LBL_JL_IVA' => 'IVA',
  'LBL_JL_TOTAL' => 'Total',
  'LBL_JL_RETENCIONIVA' => 'Retención de IVA',
  'LBL_JL_RETENCIONISR' => 'Retencion de ISR',
  'LBL_JL_PAGOS' => 'Monto pagado',
  'LBL_JL_SALDOPENDIENTE' => 'Saldo pendiente',
);