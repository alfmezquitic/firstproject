...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
            ...
            'EmailTemplates' => 'Plantillas de e-Mail',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'in_total_group_stages' => array(
        ...
        'Closed Lost' => 'Cerrado perdido',
        'Closed Dead' => 'Cerrado abandonado',
    ),
    ...
    'dom_email_errors' => array(1 => 'Seleccione sólo un usuario cuando realice una asignación directa de elementos.',
        2 => 'Debe asignar sólo los elementos seleccionados cuando realice una asignación directa de elementos.',
    ),
...
$app_strings = array(
    ...
    'LBL_GETTINGAIR' => 'Tomando Aire' /*for 508 compliance fix*/,
    ...
    'LBL_POWERED_BY_SUGARCRM' => 'Con la Tecnología de SugarCRM',
    'LBL_PRINT' => 'Imprimir',
    'LBL_HELP' => 'Ayuda',
    ...
    'LBL_ROUTING_ACTIONS_FORWARD' => 'Reenviar e-Mail',
    'LBL_ROUTING_ACTIONS_MARK_FLAGGED' => 'Marcar e-Mail para seguimiento',
    ...
    'LBL_ROUTING_ACTIONS_REPLY' => 'Responder al e-Mail',
    ...
    'LBL_ROUTING_NAME' => 'Nombre de la regla',
    ...
    'LBL_EMAIL_ADD' => 'Agregar una dirección',
    ...
    'LBL_EMAIL_ADDRESSES_TITLE' => 'e-Mails',
    ...
    'LBL_EMAIL_DEFAULTS' => 'Predeterminado',
    ...
    'LBL_EMAIL_HTML_RTF' => 'Enviar en HTML',
    ...
    'LBL_EMAIL_MENU_HELP_COMPOSE_TO_LIST' => 'Enviar por e-Mail a las listas de correo seleccionadas',
    'LBL_EMAIL_MENU_HELP_CONTACT_COMPOSE' => 'Enviar por e-Mail a este contacto',
    'LBL_EMAIL_MENU_HELP_CONTACT_REMOVE' => 'Quitar un contacto',
    'LBL_EMAIL_MENU_HELP_DELETE' => 'Eliminar estos e-Mails',
    ...
    'LBL_EMAIL_MENU_HELP_REPLY' => 'Responder a estos e-Mails',
    ...
    'LBL_EMAIL_RETRIEVING_LIST' => 'Recuperando lista de e-Mails',
    ...
    'LBL_EMAIL_SETTINGS_AUTO_IMPORT' => 'Importar e-Mail en visualización',
    ...
    'LBL_EMAIL_SETTINGS_EDIT_ACCOUNT' => 'Editar cuenta de e-Mail',
    ...
    'LBL_EMAIL_SHOW_UNREAD_ONLY' => 'Sólo mostrar no leídos',
    ...
    'LBL_EMAIL_TO' => 'Para',
    'LBL_EMAIL_TOGGLE_LIST' => 'Modo lista',
    'LBL_EMAIL_VIEW' => 'Ver',
    ...
    'LBL_CLOSE_ACTIVITY_REMEMBER' => 'No volver a mostrar:',
    ...
    'ERR_EXTERNAL_API_UPLOAD_FAIL' => 'Un error ocurrió cuando se estaba subiendo el archivo. Por favor, asegurese de que el archivo no esté vacío',
    ...
    'ERR_EXTERNAL_API_403' => 'Permiso denegado. El tipo de archivo no está soportado, permiso rechazado',
    ...
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_TITLE' => 'Agregar a la lista de público objetivo',
    ...
    'LBL_DONE_BUTTON_TITLE' => 'Completado',
    ...
    'LBL_LOCALE_NAME_EXAMPLE_TITLE' => 'Código de Monkey Extraordinariere',
    ...
    'LBL_PRODUCT_BUNDLES' => 'Paquete de productos',
    'LBL_PRODUCTS' => 'Productos',
    'LBL_PROJECT_TASKS' => 'Tareas de proyecto',
    'LBL_PROJECTS' => 'Proyectos',
    'LBL_QUOTE_TO_OPPORTUNITY_KEY' => 'O',
    'LBL_QUOTE_TO_OPPORTUNITY_LABEL' => 'Crear oportunidad a partir de cotización',
    'LBL_QUOTE_TO_OPPORTUNITY_TITLE' => 'Crear oportunidad a partir de cotización',
    'LBL_QUOTES_SHIP_TO' => 'Cotizaciones enviadas a',
    ...
    'NTC_TEMPLATES_IS_USED' => 'Las siguientes plantillas se están utilizando en registros de marketing por e-Mail. ¿Está seguro que desea eliminarlas?\n',
    ...
    'LOGIN_LOGO_ERROR' => 'Por favor, reemplace los logos de SuiteCRM.',
    ...
    'MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG' => '<item4> para aprender más sobre el módulo <item1>. Para obtener más información, use el menú desplegable de usuario localizado en la barra de navegación principal para acceder a Ayuda.',
    ...
    'LBL_SAVING_PAGE_TITLE' => 'Guardando título página...',
    ...
    'LBL_PORTAL_WELCOME_INFO' => 'El Portal de SuiteCRM es un marco que proporciona en tiempo real los casos, errores y boletines de noticias a los clientes, etc. Se trata de una interfaz externa de SuiteCRM que se puede implementar en cualquier sitio web.',
    'LBL_LIST' => 'Lista',
    ...
    'LBL_MASSUPDATE_DELETE_USER_EXISTS' => 'Este equipo privado [{0}] no puede ser eliminado hasta que el usuario [{1}] sea eliminado',

    //martin #25548
    'LBL_NO_FLASH_PLAYER' => 'Su complemento Adobe Flash Player está deshabilitado o corresponde a una versión anterior del producto. Por favor, <a href="http://get.adobe.com/es/flashplayer/">obtenga el último Adobe Flash player</a> o rehabilite el complemento instalado',
    //Collection Field
    ...
    // File fields
    'LBL_UPLOAD_FROM_COMPUTER' => 'Cargar desde su computadora',
    'LBL_SEARCH_EXTERNAL_API' => 'Archivo de origen externo',
    ...
    'ERR_RSS_INVALID_INPUT' => 'RSS no es un input_type válido',
    'ERR_RSS_INVALID_RESPONSE' => 'RSS no es un response_type válido para este método',

    //External API Error Messages
    'ERR_GOOGLE_API_415' => 'Google Docs no soporta el formato de archivo que ha provisto',
    ...
    'LBL_SEARCH_HEADER_TITLE' => 'Filtro',
...
$app_list_strings['kbdocument_canned_search'] =
    array(
        'all' => 'Todos',
        'added' => 'Agregado en los últimos 30 días',
...
// knowledge base
$app_list_strings['moduleList']['AOK_KnowledgeBase'] = 'Base de conocimiento'; // All menu entry
$app_list_strings['moduleList']['AOK_Knowledge_Base_Categories'] = 'Base de conocimiento - Categorías';// All menu entry
...
$app_strings['LBL_GENERATE_LETTER'] = 'Generar';
...
$app_list_strings['moduleList']['AM_ProjectHolidays'] = 'Proyecto vacaciones';
...
$app_strings['LBL_GANTT_BUTTON_TITLE'] = 'Vista de Gantt';
...
$app_strings['LBL_BUG_FIX'] = 'Reparar Error';
...
$app_list_strings['marker_image_list']['days_jeu'] = 'Días Jue';
...
$app_list_strings['marker_image_list']['days_mer'] = 'Días Mie';
...
$app_strings['LBL_LOGIN_AS'] = 'Inicio de sesión como ';
...
$app_strings['LBL_QUICK_DOCUMENT'] = 'Crear un documento';
$app_strings['LBL_QUICK_CALL'] = 'Programar llamada';
...
$app_list_strings['collection_temp_list'] = array('Tasks' => 'Tareas', 'Meetings' => 'Reuniones', 'Calls' => 'Llamadas', 'Notes' => 'Notas', 'Emails' => 'e-Mails');
